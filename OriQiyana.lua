...
module("Qiyana", package.seeall, log.setup)
clean.module("Qiyana", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/OriQiyana.lua", "2.0.6")
