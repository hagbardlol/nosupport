...
module("TristanaMechanics", package.seeall, log.setup)
clean.module("TristanaMechanics", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/TristanaMechanics.lua", "1.0.8")
