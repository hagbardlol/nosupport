if Player.CharName ~= "Viktor" then return end

module("hqViktor", package.seeall, log.setup)
clean.module("hqViktor", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/hqViktor.lua", "1.0.7")
