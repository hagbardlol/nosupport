...
module("Katarina", package.seeall, log.setup)
clean.module("Katarina", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/OriKatarina.lua", "1.0.9")
