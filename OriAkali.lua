...
module("Akali", package.seeall, log.setup)
clean.module("Akali", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/OriAkali.lua", "1.0.9")
