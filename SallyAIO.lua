...
module("SallyAIO", package.seeall, log.setup)
clean.module("SallyAIO", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/nosupport/main/SallyAIO.lua", "1.0.10")
