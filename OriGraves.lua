...
module("Graves", package.seeall, log.setup)
clean.module("Graves", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/OriGraves.lua", "1.0.7")
