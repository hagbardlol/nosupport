...
module("Yasuo", package.seeall, log.setup)
clean.module("Yasuo", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/OriYasuo.lua", "2.2.7")
