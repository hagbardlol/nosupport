...
module("Azir", package.seeall, log.setup)
clean.module("Azir", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/OriAzir.lua", "1.1.7")
