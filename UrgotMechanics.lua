...
module("Mechanics Urgot", package.seeall, log.setup)
clean.module("Mechanics Urgot", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/nosupport/main/UrgotMechanics.lua", "1.0.5")
