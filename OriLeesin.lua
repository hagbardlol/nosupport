...
module("Ori Leesin", package.seeall, log.setup)
clean.module("Ori Leesin", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/nosupport/main/OriLeesin.lua", "2.0.4")
